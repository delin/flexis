module.exports = (grunt) ->
  ...
  @initConfig
    ...
    sprite:
      ...
      # imgPath:   'sprite.png' # OPTIONAL: Manual override for imgPath specified in CSS
        algorithm: 'binary-tree'   # top-down, left-right, diagonal, alt-diagonal, binary-tree [best packing]
  ...
  @registerTask( 'default',    [ 'jade:dev', 'concat:js', 'stylus:dev', 'stylus:dev_ie', 'concat:css', 'concat:css_ie' ])
  @registerTask( 'livereload', [ 'default', 'connect', 'open', 'watch' ])
  @registerTask( 'publish',    [ 'concat:js', 'uglify', 'stylus:dev', 'stylus:dev_ie', 'concat:css', 'concat:css_ie', 'cssmin'])

  @registerTask( 'makejs',    [ 'concat:js', 'uglify']);
  @registerTask( 'makecss',    [ 'stylus:dev', 'stylus:dev_ie', 'concat:css', 'concat:css_ie', 'cssmin']);
